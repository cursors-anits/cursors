                            ...
                            {isSuccess && generatedData ? (
                                <div className="flex flex-col items-center text-center py-4 space-y-6">
                                    ...
                                    <div className="flex flex-col w-full max-w-md gap-3">
                                        <Button onClick={handleAutoLogin} disabled={isAutoLoggingIn} className="bg-brand-primary text-brand-dark hover:bg-brand-secondary hover:text-white w-full font-bold text-lg h-12">
                                            {isAutoLoggingIn ? <Loader2 className="w-5 h-5 animate-spin mr-2" /> : <LayoutDashboard className="w-5 h-5 mr-2" />}
                                            Go to Dashboard
                                        </Button>
                                        <Button variant="ghost" onClick={onClose} className="text-gray-400 hover:text-white h-10">
                                            Close
                                        </Button>
                                    </div>
                                </div>
